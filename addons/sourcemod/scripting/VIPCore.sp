...
public void OnPluginStart()
{
	...
	g_cHealthBonus = CreateConVar("sm_vip_health", "0", "Health bonus amount, 0 = Disable", 0, true, 0.0);
	g_cArmorBonus = CreateConVar("sm_vip_armor", "1", "Enable the armor bonus? 0 = Disable, 1 = Enable", 0, true, 0.0, true, 1.0);
	g_cPistolBonus = CreateConVar("sm_vip_pistol", "0", "Enable the pistol bonus? 0 = Disable, 1 = Enable", 0, true, 0.0, true, 1.0);
	g_cPlayerSkins = CreateConVar("sm_vip_skins", "0", "Enable the player skins? 0 = Disable, 1 = Enable", 0, true, 0.0, true, 1.0);
	g_cTablePrefix = CreateConVar("sm_vip_table_prefix", "vip", "Prefix for the database table (Default: vip)");
	g_cVipFlags = CreateConVar("sm_vip_flags", "VIP", "Flags to give the vip users, empty for nothing");
