...
public void OnPluginStart() {
	...
	(cvar = CreateConVar("sm_parachute_buttons", "7", "Enable/Disable buttons [Flags> 0: None, 1: Jump, 2: LookAtWeapon, 4: Use | e.g. 5 = Jump + Use, 7 = All]", _, true, 0.0, true, 7.0)).AddChangeHook(OnConVarChanged_Buttons);
